  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col border-none border-transparent",
          className
        )}
        {...props}
      >
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      className={cn(
        className,
        "size-7 absolute text-zinc-300 hover:bg-zinc-800 hover:text-zinc-200 cursor-pointer"
      )}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
